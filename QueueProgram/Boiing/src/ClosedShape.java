/**
 *File Name: ClosedShape
 *@version 1.1
 *Created On: 02-03-2019
 *@since 02-03-2019
 *@author Chester Descallar 978050
 *Copyright: No Copyright
 *Purpose: This class is a superclass which contains all attributes that the subclass has
...
public class ClosedShape
{
    ...
    /**
     * Determines if the Shape pulses or not
     */
     ...
     */
    protected ClosedShape(int insertionTime, boolean isPulse, int x, int y,
                          int vx, int vy, Color colour, boolean isFilled)
    {
        this.x = x;
        this.y = y;
        this.xVec = vx;
    ...
    /**
     * Makes the shape pulse (this gets overriden by all the pulseShape function in all the subclass of these
     * superclass
     */
